...
const { adminLogin, getDashboardStats, getKycSubmissions, getUsers, getUserById, updateUser, deleteUser, addBalance, removeBalance, creditBonus, freezeFunds, getBalanceHistory, getDeposits, approveDeposit, rejectDeposit, getWithdrawals, approveWithdrawal, rejectWithdrawal, addDeposit, getAuditLogs, getSettings, updateTradeSettings } = require("../controllers/adminController");
const { getAllTrades, getActiveTrades, updateTradeResult } = require("../controllers/tradeController");
