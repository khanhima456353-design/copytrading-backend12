"use strict";
(globalThis.webpackChunkfrontend = globalThis.webpackChunkfrontend || []).push([[453], { 453(e, t, n) { n.d(t, { getCLS: () => y, getFCP: () => g, getFID: () => C, getLCP: () => P, getTTFB: () => D }); var i, r, a, o, u = function (e, t) { return { name: e, value: void 0 === t ? -1 : t, delta: 0, entries: [], id: "v2-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12) }; }, c = function (e, t) { try {
        ...
        } }, d = c("layout-shift", v); d && (n = m(i, r, t), f(function () { d.takeRecords().map(v), n(!0); }), s(function () { a = 0, T = -1, r = u("CLS", 0), n = m(i, r, t); })); }, E = { passive: !0, capture: !0 }, w = new Date, L = function (e, t) { i || (i = t, r = e, a = new Date, F(removeEventListener), S()); }, S = function () { if (r >= 0 && r < a - w) {
        ...
        } }, F = function (e) { ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function (t) { return e(t, b, E); }); }, C = function (e, t) { var n, a = l(), v = u("FID"), d = function (e) { e.startTime < a.firstHiddenTime && (v.value = e.processingStart - e.startTime, v.entries.push(e), n(!0)); }, p = c("first-input", d); n = m(e, v, t), p && f(function () { p.takeRecords().map(d), p.disconnect(); }, !0), p && s(function () { var a; v = u("FID"), n = m(e, v, t), o = [], r = -1, i = null, F(addEventListener), a = d, o.push(a), S(); }); }, k = {}, P = function (e, t) { var n, i = l(), r = u("LCP"), a = function (e) { var t = e.startTime; t < i.firstHiddenTime && (r.value = t, r.entries.push(e), n()); }, o = c("largest-contentful-paint", a); if (o) {
            n = m(e, r, t);
