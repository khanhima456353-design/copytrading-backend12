...
const CV = {
  ...
  amber: "var(--clr-amber)", amberDim: "var(--clr-amber-dim)", cyan: "var(--clr-cyan)",
  sma: "#f0b90b", ema: "#0ecb81",
  bbUpper: "#3b82f6", bbMid: "#8b5cf6", bbLow: "#06b6d4",
  vwap: "#ec4899",
...
export default function Trading() {
  ...
  const renderOrderbook = () => {
    ...
    return (
      <>
        {orderbookSummary}
        {header}
      <div style={{ flex: 1, overflow: "auto", background: COLORS.bgPanel }}>
  ...
  const marketTradesPanel = (showMovers: boolean) => (
    <div style={{ borderTop: `1px solid ${COLORS.border}`, background: COLORS.bgPanel, display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", minHeight: 0, background: COLORS.bgPanel }}>
    ...
    <div ref={tradingPageRef} className="trading-page trading-dashboard" style={{ display: "flex", flexDirection: "column", height: "auto", background: COLORS.bg, color: COLORS.textBright, fontFamily: "'IBM Plex Sans', 'Helvetica Neue', sans-serif", fontSize: 13, overflowY: "auto", overflowX: "hidden", minHeight: "100dvh", scrollBehavior: "smooth", WebkitOverflowScrolling: "touch", touchAction: "pan-y", overscrollBehaviorY: "auto", position: "relative", margin: 0 }}>
      ...
      <div className="trading-main-tabs" style={{ display: "flex", alignItems: "center", height: 38, borderBottom: `1px solid ${COLORS.border}`, background: COLORS.bgPanel, padding: "0 12px", gap: 0, flexShrink: 0 }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10, padding: "8px 14px", borderRadius: 10, background: "#ff8c32", border: "1px solid #ff8c32" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.1 }}>
            <span style={{ color: "#ffffff", fontSize: 16, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: "'Inter', 'SF Pro Display', -apple-system, sans-serif" }}>SwanCore</span>
      ...
      <div className="trading-chart-panel trading-dashboard__chart-panel" style={{ flex: 1, position: "relative", overflow: "hidden", minHeight: 0, background: COLORS.bg }}>
        ...
        {activeViewTab === "trades" && (
          <div className="trading-trades-layout" style={{ display: "flex", flexDirection: "column", background: COLORS.bgPanel, overflow: "hidden", height: "100%" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 8, gridColumn: "1 / -1" }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 6, flex: 1 }}>
                  ...
                  <span style={{ fontSize: 13, color: COLORS.textBright, fontFamily: "monospace", whiteSpace: "nowrap" }}>$0.00</span>
                  <span style={{ fontSize: 11, color: COLORS.textMuted, whiteSpace: "nowrap" }}>Est. Max Buy</span>
                  <span style={{ fontSize: 13, color: COLORS.textBright, fontFamily: "monospace", whiteSpace: "nowrap" }}>0.00000000 BTC</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 6, flex: 1 }}>
                  <span style={{ fontSize: 11, color: COLORS.textMuted, whiteSpace: "nowrap" }}>Available BTC</span>
                  <span style={{ fontSize: 13, color: COLORS.textBright, fontFamily: "monospace", whiteSpace: "nowrap" }}>0.000000 BTC</span>
